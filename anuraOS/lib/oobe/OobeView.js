...
class OobeView {
            ...
            elm: (h("div", { class: "screen", id: "welcome" },
                ...
                h("div", { id: "gridContent" },
                    ...
                    h("div", { id: "bottomButtons" },
                        h("button", { "on:click": () => this.nextStep(), class: "preferredButton" }, "Get Started"))))),
            on: () => { },
        },
        {
            elm: (h("div", { class: "screen", id: "features" },
                h("h1", null, "Choose your experience"),
                h("div", { id: "subtitle" }, "What kind of Anura user are you?"),
                h("label", { class: "matter-checkbox" },
                    h("input", { type: "checkbox", "bind:checked": use(this.state.offlineEnabled) }),
                    h("span", null, "Offline Functionality")),
                h("div", { class: "sub" },
                    h("span", { class: "material-symbols-outlined" }, "info"),
                    "\u00A0This allows you to use AnuraOS without an internet connection."),
                h("br", null),
                h("label", { class: "matter-checkbox" },
                    h("input", { type: "checkbox", "bind:checked": use(this.state.v86Enabled) }),
                    h("span", null, "Linux Emulation")),
                h("div", { class: "sub" },
                    h("span", { class: "material-symbols-outlined" }, "info"),
                    "\u00A0This allows you to run Linux applications on AnuraOS."),
                h("br", null),
                h("label", { class: "matter-checkbox" },
                    h("input", { type: "checkbox", "bind:checked": use(this.state.localfsdriver) }),
                    h("span", null, "Experimental OPFS Driver")),
                h("div", { class: "sub" },
                    h("span", { class: "material-symbols-outlined" }, "info"),
                    "\u00A0Use experimental OPFS based filesystem driver. Comes with a speed improvement at the cost of system stability."),
                h("br", null),
                h("div", { id: "size", class: "sub" },
                    h("span", { class: "material-symbols-outlined" }, "download"),
                    "\u00A0",
                    use(this.state.dlsize),
                    " download"),
                h("div", { class: "sub" },
                    h("span", { class: "material-symbols-outlined" }, "info"),
                    "\u00A0These features can always be enabled in Settings."),
                h("div", { id: "gridContent" },
                    h("img", { id: "animation", src: "assets/oobe/checking_for_update.gif" }),
                    h("div", { id: "bottomButtons" },
                        h("button", { "on:click": async () => {
                                ...
                                if (this.state.localfsdriver) {
                                    await window.idbKeyval.set("bootFromOPFS", true);
                            ...
                            h("div", { style: {
                                ...
                                $if(use(this.state.v86Enabled), h("span", null, "Next"), h("span", null,
                                    h("span", null, "Finish"))),
                                $if(use(this.state.v86Enabled), h("span", { class: "material-symbols-outlined" }, "chevron_right")))))))),
            on: () => { },
        },
        {
    ...
    async complete() {
        ...
        if (this.state.localfsdriver) {
            await anura.fs.promises.writeFile("/opfs/anura_settings.json", JSON.stringify(anura.settings.cache));
    ...
    if (typeof anura.config.x86[x86image].rootfs === "string") {
        ...
        const doWhenAvail = function () {
            ...
            fetch(anura.config.x86[x86image].rootfs[assigned])
                ...
                console.debug(anura.config.x86[x86image].rootfs.length -
                    doneSoFar +
                    " chunks to go");
            })
                .catch((e) => {
