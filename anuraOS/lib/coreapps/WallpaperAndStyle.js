...
class WallpaperAndStyle extends App {
    ...
    page = async () => (h("div", { style: "height:100%;width:100%;position:absolute", class: `background ${this.css}` },
        h("div", { class: "header" },
            h("span", null,
                h("h2", { "on:click": () => {
            ...
            $if(use(this.state.tab, (tab) => tab === "colors"), h("span", { id: "btns", "bind:hidden": use(this.state.tab, (tab) => tab === "wallpapers") },
                h("button", { style: {
                    ...
                    h("span", { class: "material-symbols-outlined" }, "restore"),
                    "Reset"),
                h("button", { style: {
                        color: use(anura.ui.theme.state.foreground),
                    }, "on:click": () => {
                ...
                h("button", { style: {
                    ...
                    "Import")))),
        $if(use(this.state.tab, (tab) => tab === "wallpapers"), h("div", { style: "flex-direction: column; height: 100%;" },
                    ...
                    h("div", { class: "wall-fit" },
                        h("select", { name: "fit-select", id: "fit-select", "on:change": (e) => {
                            ...
                            h("option", { value: "cover", selected: 
                                ...
                                anura.settings.get("wallpaper-fit") === "cover" }, "Cover"),
                            h("option", { value: "contain", selected: anura.settings.get("wallpaper-fit") === "contained" }, "Contain"),
                            h("option", { value: "auto", selected: anura.settings.get("wallpaper-fit") === "auto" }, "Auto")),
            ...
            })), h("div", { id: "colors" }, this.colorEditors.map((color) => (h("div", { class: "editor" },
            color.name,
    ...
    updateCurrentWallpaperElements() {
        ...
        currWallpaperName.innerText = currWallpaper.name;
    ...
    setWallpaper(url) {
        window.document.documentElement.style.backgroundColor = anura.settings.get("wallpaper-contain-color"); // this might not be ideal but it works
...
//# sourceMappingURL=WallpaperAndStyle.js.map