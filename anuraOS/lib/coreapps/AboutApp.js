...
class AboutApp extends App {
    ...
    page = () => (h("div", { class: "aboutapp-container" },
        h("div", { class: "aboutapp-logo" },
            h("div", { class: "aboutapp-logo-img", title: "Look what you've done", "on:click": () => {
        ...
        h("div", { class: "aboutapp-content" },
            ...
            h("br", null),
            $if(anura.settings.get("bootFromOPFS"), h("p", null, "Anura is booting from OPFS."), h("p", null, "Anura OPFS boot disabled.")),
            h("br", null),
            h("br", null),
            h("p", null,
                ...
                h("button", { "on:click": () => {
                    ...
                    }, class: "aboutapp-link-button" }, "GNU AGPLv3"),
                "."))));
    constructor() {
        super();
    }
    async open(args = []) {
        ...
        if (fullscreenEasterEgg) {
            aboutview.content.appendChild(h("div", { style: "background: url(/assets/images/idol.gif); width: 100%; height: 100%; background-size: contain; background-repeat: no-repeat;" }));
        }
        else {
