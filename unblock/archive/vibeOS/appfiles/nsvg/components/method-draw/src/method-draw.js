...
(function() {
  ...
  if(!window.methodDraw) window.methodDraw = function($) {
    ...
    curConfig = {
      ...
      initOpacity: 1,
      imgPath: 'components/method-draw/images/',
      extPath: 'components/method-draw/extensions/',
      jGraduatePath: 'components/method-draw/lib/jgraduate/images/',
      extensions: [],
      initTool: 'select',
      wireframe: false,
    ...
    Editor.init = function() {
      ...
      var selectedChanged = function(window,elems) {        
        ...
        if(typeof window.methodDraw.onSelect === 'function') window.methodDraw.onSelect({
          elements: elems,
          selectedElement: selectedElement,
          multiselected: multiselected
        });
...
//        var opacity = (picker == 'stroke' ? $('#stroke_opacity') : $('#fill_opacity'));
      ...
      setTimeout(function() {
        svgCanvas.embedImage('components/method-draw/images/placeholder.svg', function(datauri) {
          if(!datauri) {
            // Disable option
